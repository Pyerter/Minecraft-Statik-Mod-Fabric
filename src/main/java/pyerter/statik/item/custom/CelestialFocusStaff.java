...
public class CelestialFocusStaff extends Item {
    public CelestialFocusStaff(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if(Screen.hasShiftDown()) {
            ...
            tooltip.add(Text.literal("Press Shift for more info").formatted(Formatting.WHITE));
        }
